...
import cn.suwg.mybatis.reflection.MetaClass;
...
import cn.suwg.mybatis.reflection.invoker.Invoker;
...
public class BeanWrapper extends BaseWrapper {
    ...
    public MetaObject instantiatePropertyValue(String name, PropertyTokenizer prop, ObjectFactory objectFactory) {
        ...
        try {
            ...
            throw new RuntimeException("Cannot set value of property '" + name + "' because '" + name + "' is null "
                    + "and cannot be instantiated on instance of " + type.getName() + ". Cause:" + e.toString(), e);
        }
        return metaValue;
    }
    ...
    private Object getBeanProperty(PropertyTokenizer prop, Object object) {
        try {
            ...
            throw new RuntimeException("Cannot get value of property '" + prop.getName() + "' on instance of "
